...
class Powerscan1D:
    ...
    def __init__(self):
        ...
        plt.plot(mvolts, 1/sqrt(3)*2*mvolts/5, "black")
        plt.plot(mvolts, self._Omega_2s*sqrt(3)/3*2*1e3, "o", color="C0")
        plt.text(.1, .7, r"$\Omega_2 = \frac{2}{\sqrt{3}} V_{rms} \cdot %.2f$ MHz/mV"%(sqrt(3)/3*2/5),
